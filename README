...
5.  Navigate to and select the directory you placed the Lojban Dictionary source code.
6.  Lojban Dictionary should now appear in the Extensions list.  Press the small right-pointing arrow left of it's icon to expand the details and then select the text that follows "ID:".
